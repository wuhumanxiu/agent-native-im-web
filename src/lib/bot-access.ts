export function buildBotAccessText(params: {
  ...
  return [
    ...
    '',
    'If ANI does not appear online after updating config, reconnect or restart the relevant gateway runtime. For Hermes, first confirm https://github.com/wuhumanxiu/hermes-ani-adapter has been installed.',
  ].join('\n')
}
